...
export default function LoginPage() {
  ...
  if (isCheckingAuth) {
    return (
      <main className="min-h-screen flex items-center justify-center bg-linear-to-br from-[#0f2847] via-[#1e3a5f] to-[#0f2847]">
        <div className="animate-pulse flex flex-col items-center gap-4">
          <div className="w-16 h-16 rounded-2xl bg-linear-to-br from-[#f97316] to-[#ea580c] shadow-lg shadow-orange-500/30" />
  ...
  return (
    <main className="min-h-screen flex items-center justify-center relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-linear-to-br from-[#0f2847] via-[#1e3a5f] to-[#0f2847]">
        {/* Grid Pattern */}
        <div
      ...
      <motion.div
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl shadow-black/20 overflow-hidden">
          {/* Header */}
          <div className="bg-linear-to-r from-[#1e3a5f] to-[#0f2847] px-8 py-10 text-center">
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{ delay: 0.2, type: "spring", stiffness: 200 }}
              className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-linear-to-br from-[#f97316] to-[#ea580c] mb-4 shadow-lg shadow-orange-500/30">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <motion.button
              ...
              className="w-full py-4 rounded-xl bg-linear-to-r from-[#f97316] to-[#ea580c] text-white font-semibold flex items-center justify-center gap-2 shadow-lg shadow-orange-500/25 hover:shadow-xl hover:shadow-orange-500/30 disabled:opacity-70 disabled:cursor-not-allowed transition-all">
              {isLoading ? (
                <>
